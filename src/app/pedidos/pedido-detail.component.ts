  ...
  template: `
    <ng-container *ngIf="pedido$ | async as pedido">
      ...
      <div class="row g-2">
        ...
        <div class="col-12 col-md-6">
          <div class="card mb-3 h-100">
            ...
            <div class="card-body">
              <div><strong>Cantidad de ternos:</strong> {{pedido.cantidadTernos || '-'}} </div>
      ...
      <div class="d-flex flex-column flex-md-row gap-2 mt-3">
        <button class="btn btn-secondary w-100 w-md-auto" (click)="volver()">Volver</button>
        <button class="btn btn-primary w-100 w-md-auto" [disabled]="pedido.estado === 'en_proceso' || pedido.estado === 'terminado' || pedido.estado === 'entregado'" (click)="cambiarAEnProceso(pedido)">
